...
Diagram \ref{hossy} przedstawia etap poszukiwania formacji hossy. W momencie wystąpienia trendu głównego o kierunku wzrostowym wraz z krótkookresowym trendem malejącym następuje wywołanie tego fragmentu algorytmu. Opisywana część algorytmu dzieli się na szukanie formacji:
\begin{enumerate}
\item młota
